        ...
        init() {
            if (!this.widet) {
                this.widget = new TvWidget({
                    ...
                    overrides: {
                        //对Widget对象的默认属性进行覆盖
                        "paneProperties.background": this.config.bg,
                        "scalesProperties.lineColor": "#989a9c", //xy边框颜色
                        ...
                        "paneProperties.horzGridProperties.color": this.config.line, //x
                        "paneProperties.vertGridProperties.color": this.config.line, //y
                    ...
                    toolbar_bg: this.config.bg //最外面的边框颜色
                    // overrides: {
