    ...
    <div class="main" style="">
        ...
        <div class="cc-head clear">
            ...
            <div class="head-right">
                ...
                <p @click="$router.push('/release')">发布交易信息</p>
        ...
        <div class="cc-tab">
            ...
            <div class="cc-nav">
                <ul>
                    <li  :class="{'active':tabactive==1}" @click="tabactive=1">购买</li>
                    <li :class="{'active':tabactive==0}" @click="tabactive=0">出售</li>
                </ul>
                <div class="orders_btn" @click="$router.push('/ccBills')">
                    <span>订单</span>
                    <!-- <img src="../../../../static/images/orders.png" style="width:1.6rem"> -->
                </div>
            </div>
        ...
        <div class="cc-cont">
            <!-- <van-list v-model="loading" :finished="finished" @load="onLoad"> -->
                <!-- <van-cell v-for="(i,index) in c2clist" :key="index"> -->
                    <!-- new -->
                    <ul>
                        <li class="cc-item" v-for="(i,index) in c2clist" :key="index" @click="ordershow(i)">
                            <div class="i_top">
                                <div class="cont-he">
                                    <i>
                                        <!-- {{headstr(i.nickName)}} -->
                                        <img style="width: 2rem;height: 2rem;" src="../../../../static/images/head.png"></i>
                            ...
                            <div class="i_bottom">
                                ...
                                <p>限额：{{i.minQuota}}-{{i.maxQuota}} CNY </p>
                                <div class="i_buy">
                                    <p>数量：{{i.practicalNum}} {{i.currencyCode}}</p>
                                    <!-- <button>买入</button> -->
                ...
                <!-- </van-cell> -->
                <div class="more" style="pointer-events: auto;" @click="loadmore" v-show='c2clist.length!=0'>
        ...
        <!-- new -->
        <div class="pay_popup"  :style="popup?{bottom:0}:''">
            <div class="p_top">
                <div class="close" @click.stop="popup=false">
                    <img style="width: 1.3rem" src="../../../../static/images/close.png" alt="">
                </div>
                <span class="trade_text">{{c2citem.direction==1?'买入':'卖出'}} {{c2citem.currencyCode}}</span>
                <span class="money_text">{{c2citem.price}} CNY</span>
                <span class="limit_text">限额 {{c2citem.minQuota}}-{{c2citem.maxQuota}} CNY</span>
                <ul class="pay_type" >
                    <li v-if="c2citem.aliPay">
                        <div><img src="../../../../static/images/cc2.png"></div>
                        <span>支付宝</span>
                    </li>
                    <li v-if="c2citem.weChatPay">
                        <div><img src="../../../../static/images/cc3.png"></div>
                        <span>微信</span>
                    </li>
                    <li v-if="c2citem.bankPay">
                        <div><img src="../../../../static/images/cc4.png"></div>
                        <span>银行卡</span>
                    </li>
                </ul>
            </div>
            <div class="p_bottom">
                <ul class="pay_input">
                    <li>
                        <input type="text" :placeholder="`最大可买 ${c2citem.maxQuota}`"  v-model="ordermoney" @input="ordermoneychange"  >
                        <div class="all_buy">
                            <span>CNY</span>
                            <em>|</em>
                            <i @click='buyall'>全部{{c2citem.direction==1?'买入':'卖出'}}</i>
                        </div>
                    </li>
                    <li>
                        <input type="text" :placeholder="`最大可买 ${c2citem.practicalNum}`" v-model="ordernum" @input="ordernumchange">
                        <span>USDT</span>
                    </li>
                </ul>
                <v-select class="pay_list" v-if='!c2cdata.direction' multiple v-model="selected" :options="options" placeholder='请选择收款方式'>
                    <div slot="no-options">请添加收款方式!</div>
                </v-select>                
                <div class="tip">
                    <span >订单需要您在15分钟内进行支付</span>
                </div>
                <div class="pay_btn">
                    <button @click.stop="popup=false" class="font-weight: 700;">{{btntext}}</button>
                    <button @click.stop="order()" class="buy_btn">下单</button>
                </div>
            </div>
        </div>
        <!-- new -->
